...
public class Left extends LinearOpMode {
   ...
   // DistanceSensor distanceSensorMeasure;
...
//    Servo poleMeasure;
    ...
    public void runOpMode(){
       ...
       // distanceSensorMeasure = hardwareMap.get(DistanceSensor.class, "distanceSensorMeasure");
      ...
      //  poleMeasure = hardwareMap.get(Servo.class, "poleMeasure");
        ...
        moveToPosition(21.5,0.2);

        sleep(100);

        strafeToPosition(-1,0.2);

        while (distanceSensor.getDistance(DistanceUnit.MM) > 15) {
                moveToPosition(0.2, 0.2);
        }
        ...
        telemetry.addData("Position: ", specialCone);
        telemetry.update();
...
//
      ...
      while (distanceSensor.getDistance(DistanceUnit.MM) > 100) {
            strafeToPosition(0.2, 0.3);
        }*/
//
        sleep(400);
        ...
        ArmMotor.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
        ArmMotor.setVelocity(1200);

        sleep(2000);

        moveToPosition(7.5, 0.2);
//
        //poleMeasure.setPosition(0.5);

      /*  while (distanceSensorMeasure.getDistance(DistanceUnit.MM) > 30) {
            moveToPosition(0.5, 0.3);
        } */

       // poleMeasure.setPosition(0);

        sleep(100);

        moveToPosition(1.5, 0.3);
//
        sleep(1000);
        ...
        if (specialCone == 1) {
            strafeToPosition(-64, 0.3);
        } else if (specialCone == 2) {
            strafeToPosition(-35, 0.3);
